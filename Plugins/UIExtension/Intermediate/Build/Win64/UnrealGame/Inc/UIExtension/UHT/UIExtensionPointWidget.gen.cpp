...
void UUIExtensionPointWidget::FOnConfigureWidgetForData_DelegateWrapper(const FScriptDelegate& OnConfigureWidgetForData, UUserWidget* Widget, UObject* DataItem)
{
	...
	struct Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_UIExtension_Source_Public_Widgets_UIExtensionPointWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_UIExtension_Source_Public_Widgets_UIExtensionPointWidget_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_UIExtension_Source_Public_Widgets_UIExtensionPointWidget_h_2545218592(TEXT("/Script/UIExtension"),
		Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_UIExtension_Source_Public_Widgets_UIExtensionPointWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_UIExtension_Source_Public_Widgets_UIExtensionPointWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
