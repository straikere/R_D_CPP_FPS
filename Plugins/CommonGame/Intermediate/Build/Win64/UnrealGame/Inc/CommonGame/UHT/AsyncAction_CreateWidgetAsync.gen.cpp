...
void FCreateWidgetAsyncDelegate_DelegateWrapper(const FMulticastScriptDelegate& CreateWidgetAsyncDelegate, UUserWidget* UserWidget)
{
	...
	struct Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_CreateWidgetAsync_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_CreateWidgetAsync_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_CreateWidgetAsync_h_1213519816(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_CreateWidgetAsync_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_CommonGame_Source_Public_Actions_AsyncAction_CreateWidgetAsync_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
