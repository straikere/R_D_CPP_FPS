...
template<> COMMONGAME_API UScriptStruct* StaticStruct<FRootViewportLayoutInfo>()
{
	...
	struct Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_344517437(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_CommonGame_Source_Public_GameUIPolicy_h_Statics::EnumInfo));
