...
template<> GAMESETTINGS_API UScriptStruct* StaticStruct<FGameSettingNameExtensions>()
{
	...
	struct Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h_71356319(TEXT("/Script/GameSettings"),
		Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_R_D_R_D_CPP_FPS_Plugins_GameSettings_Source_Public_Widgets_GameSettingVisualData_h_Statics::ScriptStructInfo),
		nullptr, 0);
