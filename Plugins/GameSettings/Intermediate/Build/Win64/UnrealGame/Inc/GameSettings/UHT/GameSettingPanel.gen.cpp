...
void UGameSettingPanel::FOnExecuteNamedActionBP_DelegateWrapper(const FMulticastScriptDelegate& OnExecuteNamedActionBP, UGameSetting* Setting, FGameplayTag Action)
{
	...
	struct Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_GameSettings_Source_Public_Widgets_GameSettingPanel_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_GameSettings_Source_Public_Widgets_GameSettingPanel_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_GameSettings_Source_Public_Widgets_GameSettingPanel_h_3749654504(TEXT("/Script/GameSettings"),
		Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_GameSettings_Source_Public_Widgets_GameSettingPanel_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Lyra_LyraStarterGame_Plugins_GameSettings_Source_Public_Widgets_GameSettingPanel_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
